...
public class SearchDataAdapter extends BaseAdapter {
	...
	//Construct
	public SearchDataAdapter(Context c, ArrayList<GeneralSearchResult> m, LayoutInflater l) {
	...
	public long getItemId( int position ) {
		...
		return ( temp.hasProfileData() ? temp.getProfileData().getProfileId() : temp.getPlatoonData().getId() );
	...
	public View getView( int position, View convertView, ViewGroup parent ) {
		...
		if( getItemViewType(position) == 0 ) { 
			...
			if ( convertView == null ) {
				...
				convertView = layoutInflater.inflate( R.layout.list_item_search_profile, parent, false );
			...
			if ( convertView == null ) {
				...
				convertView = layoutInflater.inflate( R.layout.list_item_search_platoon, parent, false );
