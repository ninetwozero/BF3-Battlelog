...
public class ThreadPostListAdapter extends BaseAdapter {
	...
	//Construct
	public ThreadPostListAdapter(Context c, ArrayList<Board.PostData> m, LayoutInflater l) {
	...
	public View getView( int position, View convertView, ViewGroup parent ) {
		...
		if ( convertView == null ) {
			...
			convertView = layoutInflater.inflate( R.layout.list_item_forum_post, parent, false );
