...
public class DashboardPopupPlatoonListAdapter extends BaseAdapter {
	...
	//Construct
	public DashboardPopupPlatoonListAdapter(Context c, ArrayList<PlatoonData> p, LayoutInflater l) {
	...
	public View getView( int position, View convertView, ViewGroup parent ) {
		...
		if ( convertView == null ) {
			...
			convertView = layoutInflater.inflate( R.layout.list_item_dashboard_platoon, parent, false );
