...
public class RankProgressDAO {
    ...
    public static RankProgress rankProgressFromCursor(Cursor cursor) {
        ...
        rp.setPersonaId(cursor.getLong(cursor
                .getColumnIndexOrThrow(RankProgress.Columns.PERSONA_ID)));
        rp.setPersonaName(cursor.getString(cursor
                .getColumnIndexOrThrow(RankProgress.Columns.PERSONA_NAME)));
        rp.setPlatform(cursor.getString(cursor
                .getColumnIndexOrThrow(RankProgress.Columns.PLATFORM)));
        rp.setRank(cursor.getInt(cursor
                .getColumnIndexOrThrow(RankProgress.Columns.RANK)));
        rp.setCurrentRankScore(cursor.getLong(cursor
                .getColumnIndexOrThrow(RankProgress.Columns.CURRENT_RANK_SCORE)));
        rp.setNextRankScore(cursor.getLong(cursor
                .getColumnIndexOrThrow(RankProgress.Columns.NEXT_RANK_SCORE)));
        rp.setScore(cursor.getLong(cursor
                .getColumnIndexOrThrow(RankProgress.Columns.SCORE)));
        return rp;
    }
    ...
    public static ContentValues rankProgressForDB(PersonaInfo pi, long personaId) {
        ...
        values.put(RankProgress.Columns.PERSONA_NAME, pi.getUser()
                .getUserName());
        values.put(RankProgress.Columns.PLATFORM,
                platformName(pi.getPlatform()));
        values.put(RankProgress.Columns.RANK, pi.getCurrentRank().getLevel());
        values.put(RankProgress.Columns.CURRENT_RANK_SCORE, pi.getCurrentRank()
                .getRankPoints());
        values.put(RankProgress.Columns.NEXT_RANK_SCORE, pi.getNextRank()
                .getRankPoints());
