...
public class Backup_CompareView extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.tab_content_compare);
    ...
    private class GetDataSelfAsync extends
        ...
        public GetDataSelfAsync(Context c, int ap) {
            ...
            progressDialog = null;
            if (playerData1 == null) {
                playerData1 = new HashMap<Long, PersonaStats>();
            }
            if (playerData2 == null) {
                playerData2 = new HashMap<Long, PersonaStats>();
            }
            profileIdArray = null;
            arrayPosition = ap;
        ...
        protected Boolean doInBackground(ProfileData... arg0) {
            ...
            try {
                ...
                if (profileIdArray == null) {
                    ...
                    profileIdArray[1] = profileData[1]
                            .getPersonaId(arrayPosition);

                }

                // Grab the stats
                playerData1 = WebsiteHandler.getStatsForUser(context,
                        profileData[0]);
                playerData2 = WebsiteHandler.getStatsForUser(context,
                        profileData[1]);

                if (playerData1 != null && playerData2 != null) {
                    return true;
                } else {
                    return false;
                }
    ...
    public Dialog generateDialogPersonaList(final Context context,
            final long[] personaId, final String[] persona, final int pos) {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        if (personaId[item] != selectedPersona[pos]) {
                            ...
                            if (pos == 0) {
                                ...
                                populateStats(playerData1.get(selectedPersona[pos]),
                                        pos);

                            } else {

                                populateStats(playerData2.get(selectedPersona[pos]),
                                        pos);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.string_persona_0) {
            ...
            // Let's get it on!
            generateDialogPersonaList(this, playerOne.getPersonaIdArray(),
                    playerOne.getPersonaNameArray(), 0).show();

        } else if (v.getId() == R.id.string_persona_1) {

            generateDialogPersonaList(this, playerTwo.getPersonaIdArray(),
                    playerTwo.getPersonaNameArray(), 1).show();
