...
public class MODForumHandler extends DefaultHandler {
    ...
    public MODForumHandler() {

        requestHandler = new RequestHandler();

    }

    public boolean reportPost(Context c, long pId, String r)
            throws WebsiteHandlerException {

        try {
            // Setup a RequestHandler
            final String httpContent = requestHandler.post(
    ...
    public ArrayList<ForumSearchResult> search(final Context c, final String keyword)
            throws WebsiteHandlerException {
