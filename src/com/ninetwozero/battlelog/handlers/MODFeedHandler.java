...
public class MODFeedHandler extends DefaultHandler {
    ...
    public MODFeedHandler(long i, int t) {
    ...
    public boolean hooah(long postId, String checksum)
            throws WebsiteHandlerException {
    ...
    public boolean unhooah(long postId, String checksum)
            throws WebsiteHandlerException {
