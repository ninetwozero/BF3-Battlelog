...
public class ProfileListDialogFragment extends DialogFragment {
	...
	public static ProfileListDialogFragment newInstance(
			List<ProfileData> profiles, String tag) {
		ProfileListDialogFragment dialog = new ProfileListDialogFragment(
				profiles, tag, R.string.info_dialog_selection_profile);
	...
	public static ProfileListDialogFragment newInstance(
			List<ProfileData> profiles, String tag, int title) {
		ProfileListDialogFragment dialog = new ProfileListDialogFragment(
				profiles, tag, title);
		Bundle bundle = new Bundle();
		dialog.setArguments(bundle);
	...
	private ProfileListDialogFragment(List<ProfileData> data, String tag,
			int title) {
		this.data = data;
		this.TAG = tag;
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		ListView listView = (ListView) listViewLayout
		...
		listView.setAdapter(new ProfileListAdapter(getActivity(), data,
				layoutInflater));
