...
public class FeedItemDataFactory {
    ...
    public static ParsedFeedItemData feedItemDataFrom(Context context, int feedItemTypeId,
                                                      ProfileData profileData, JSONObject currItem) {
            ...
            switch (feedItemTypeId) {
                ...
                case FeedItem.TYPE_NEW_FORUM_THREAD:
                    feedItemData = generateFromNewThread(context,
                            currItem.getJSONObject("CREATEDFORUMTHREAD"), profileData);
                break;
                ...
                case FeedItem.TYPE_GOT_PLATOON_POST:
                    feedItemData = generateFromPlatoonPost(context,
                            currItem.getJSONObject("RECEIVEDPLATOONWALLPOST"), profileData);
                break;
                ...
                case FeedItem.TYPE_NEW_EMBLEM:
                    feedItemData = generateFromNewPlatoonEmblem(context,
                            currItem.getJSONObject("PLATOONBADGESAVED"), profileData);
                break;
                ...
                case FeedItem.TYPE_COMPLETED_ASSIGNMENT:
                    feedItemData = generateFromCompletingAssignment(context,
                            currItem.getJSONObject("COMPLETEDASSIGNMENT"), profileData);
                break;
                case FeedItem.TYPE_NEW_COMMENT_GAME:
                    feedItemData = generateFromCommentOnGameReport(context,
                            currItem.getJSONObject("COMMENTEDGAMEREPORT"), profileData);
                break;
    ...
    private static ParsedFeedItemData generateFromNewForumPost(Context context, JSONObject currItem,
    ...
    private static ParsedFeedItemData generateFromUnlockedExpansion(Context context, JSONObject currItem,
                                                                   ProfileData profile)
    ...
    private static ParsedFeedItemData generateFromCommentOnBlog(Context context, JSONObject currItem,
                                                               ProfileData profile)
            throws JSONException {
        return new ParsedFeedItemData(
    ...
    private static ParsedFeedItemData generateFromCommentOnGameReport(Context context,
                                                                     JSONObject currItem,
                                                                     ProfileData profile)
            throws JSONException {
        return new ParsedFeedItemData(
                ...
                currItem.getString(GAME_REPORT_COMMENT),
                new ProfileData[]{
    ...
    private static ParsedFeedItemData generateFromCompletingAssignment(Context context,
                                                                      JSONObject currItem,
                                                                      ProfileData profile)
            throws JSONException {
    ...
    private static ParsedFeedItemData generateFromAward(Context context, JSONObject currItem,
                                                       ProfileData profile)
            throws JSONException {
    ...
    private static ParsedFeedItemData generateFromGameReport(Context context, JSONObject currItem,
                                                            ProfileData profile)
            throws JSONException {
    ...
    private static ParsedFeedItemData generateFromLeavingPlatoon(Context context, JSONObject currItem,
                                                                ProfileData profile)
            throws JSONException {
    ...
    private static ParsedFeedItemData generateFromGettingKickedFromPlatoon(Context context,
                                                                          JSONObject currItem,
                                                                          ProfileData profile)
            throws JSONException {
    ...
    private static ParsedFeedItemData generateFromJoiningPlatoon(Context context, JSONObject currItem,
                                                                ProfileData profile)
            throws JSONException {
        JSONObject platoonObject = currItem.getJSONObject(PLATOON);
        return new ParsedFeedItemData(
    ...
    private static ParsedFeedItemData generateFromNewPlatoonEmblem(Context context, JSONObject currItem,
                                                                  ProfileData profile)
            throws JSONException {
        JSONObject platoonObject = currItem.getJSONObject(PLATOON);
        return new ParsedFeedItemData(
    ...
    private static ParsedFeedItemData generateFromCreatingNewPlatoon(Context context, JSONObject currItem,
                                                                    ProfileData profile)
            throws JSONException {
    ...
    private static ParsedFeedItemData generateFromCompletingLevel(Context context, JSONObject currItem,
                                                                 ProfileData profile)
            throws JSONException {
        ...
        ).gravatarHash(friendObject.getString(GRAVATAR_MD_5)).build();
    ...
    private static ParsedFeedItemData generateFromReachingNewRank(Context context, JSONObject currItem,
                                                                 ProfileData profile)
            throws JSONException {
        return new ParsedFeedItemData(
                PublicUtils.createStringWithData(
    ...
    private static ParsedFeedItemData generateFromFavoritingServer(Context context, JSONObject currItem,
                                                                  ProfileData profile)
            throws JSONException {
        return new ParsedFeedItemData(
    ...
    private static ParsedFeedItemData generateFromPlatoonPost(Context context, JSONObject currItem,
                                                             ProfileData profile)
            throws JSONException {
        JSONObject platoonObject = currItem.getJSONObject(PLATOON);
        return new ParsedFeedItemData(
    ...
    private static ParsedFeedItemData generateFromWallPost(Context context, JSONObject currItem,
        ...
        ).gravatarHash(otherUserObject.getString(GRAVATAR_MD_5)).build();
    ...
    private static ParsedFeedItemData generateFromNewThread(Context context, JSONObject currItem,
                                                           ProfileData profile)
            throws JSONException {
    ...
    private static ParsedFeedItemData generateFromNewFriend(Context context, JSONObject currItem,
                                                           ProfileData profile)
            throws JSONException {
        ...
        ).gravatarHash(friendUser.getString(GRAVATAR_MD_5)).build();
    ...
    private static ParsedFeedItemData generateFromNewStatus(JSONObject currItem,
                                                           ProfileData profile)
            throws JSONException {
        return new ParsedFeedItemData(
