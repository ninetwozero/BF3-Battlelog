...
public class DataBank {
	...
	static{
    	...
    	WEAPONS.put("E7266EC2-4977-60F2-A7CB-6EF7D98A5E2E", new WeaponType("E7266EC2-4977-60F2-A7CB-6EF7D98A5E2E", "HK53", "hk53", 750, "MEDIUM", "30 [5.56x45mm NATO]", true, false, true));
		...
		ASSIGNMENTS.put("ID_XP1_ASSIGNMENT_3", new String[] { "Fixing it", "HK53" });
