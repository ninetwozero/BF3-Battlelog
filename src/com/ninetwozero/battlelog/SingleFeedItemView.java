...
public class SingleFeedItemView extends ListActivity {
	...
	public class AsyncForumSearch extends AsyncTask<String, Void, Boolean> {
		...
		protected void onPreExecute() {
			...
			if( context instanceof SingleFeedItemView ) { 
				
				((SingleFeedItemView) context).toggleSearchButton();
		...
		protected void onPostExecute( Boolean results ) {
			...
			if( results ) { 
				...
				if( context instanceof SingleFeedItemView ) { 
					...
					((SingleFeedItemView) context).setupList(threads);
					((SingleFeedItemView) context).toggleSearchButton();
