        ...
        protected Boolean doInBackground(ProfileData... arg0) {
            ...
            try {
                ...
                if (arg0[0].getNumPersonas() == 0) {
                    ...
                    unlocks = WebsiteHandler.getUnlocksForUser(profileData, sharedPreferences.getInt(Constants.SP_BL_UNLOCKS_LIMIT_MIN, 1));
                    ...
                    unlocks = WebsiteHandler.getUnlocksForUser(arg0[0], sharedPreferences.getInt(Constants.SP_BL_UNLOCKS_LIMIT_MIN, 1));
