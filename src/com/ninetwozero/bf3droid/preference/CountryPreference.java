...
import com.ninetwozero.bf3droid.datatype.ProfileSettings;
...
public class CountryPreference extends DialogPreference {
    ...
    private String[] countriesArray() {
        Set<String> keys = ProfileSettings.COUNTRY.keySet();
        return keys.toArray(new String[0]);
    }

    private String countryPreference() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getContext());
        return preferences.getString(ProfileSettings.PROFILE_INFO_COUNTRY, "");
    }
    ...
    private void saveSharedPreferences() {
        ...
        editor.putString(ProfileSettings.PROFILE_INFO_COUNTRY, countryValue());
        editor.commit();
    }
    ...
    private String keyToValue() {
        return ProfileSettings.COUNTRY.get(stringToKey());
    }
    ...
    private String valueToKey(String value) {
        for (Map.Entry<String, String> entry : ProfileSettings.COUNTRY.entrySet()) {
