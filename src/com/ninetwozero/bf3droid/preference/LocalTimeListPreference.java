...
public class LocalTimeListPreference extends ListPreference {
    ...
    private CharSequence[] entryValues() {
        return ProfileSettings.LOCAL_TIME_VALUES;
    }

    private CharSequence[] listOfTimes() {
        Date today = new Date(today());
        List<String> hours = new ArrayList<String>();
        for (CharSequence value : ProfileSettings.LOCAL_TIME_VALUES) {
    ...
    private int indexOf(CharSequence value) {
        List<CharSequence> valuesList = Arrays.asList(ProfileSettings.LOCAL_TIME_VALUES);
